...
Portail::Portail(QObject* parent) : Batiment(parent, MAX_PV_PORTAIL, QSize(TAILLE_PORTAIL_X, TAILLE_PORTAIL_Z), cout{COUT_CONSTRUCTION_NOURRITURE_PORTAIL, COUT_CONSTRUCTION_OR_PORTAIL, XP_PORTAIL})
{
