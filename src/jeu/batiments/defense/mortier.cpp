...
Mortier::Mortier(QObject* parent) : Defense(parent, MAX_PV_MORTIER, QSize(TAILLE_MORTIER_X, TAILLE_MORTIER_Z), cout{COUT_CONSTRUCTION_NOURRITURE_MORTIER, COUT_CONSTRUCTION_OR_MORTIER, XP_MORTIER})
{
