#include "conteneur_or.h"

Conteneur_Or::Conteneur_Or(QObject* parent) : Conteneur(parent, MAX_PV_CONTENEUR_OR, QSize(TAILLE_CONTENEUR_OR_W, TAILLE_CONTENEUR_OR_H), cout{COUT_CONSTRUCTION_CONTENEUR_OR_NOURRITURE, COUT_CONSTRUCTION_CONTENEUR_OR_OR, XP_CONTENEUR}, CONTENANCE_MAX_CONTENEUR_OR)
{
