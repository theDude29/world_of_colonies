#include "travailleur_or.h"

Travailleur_Or::Travailleur_Or(QObject* parent, bool active)
    : Travailleur(parent, MAX_PV_TRAVAILLEUR_OR, QSize(TAILLE_TRAVAILLEUR_OR_W, TAILLE_TRAVAILLEUR_OR_H), cout{COUT_CONSTRUCTION_TRAVAILLEUR_OR_NOURRITURE, COUT_CONSTRUCTION_TRAVAILLEUR_OR_OR, XP_TRAVAILLEUR}, CONTENANCE_MAX_TRAVAILLEUR_OR, PRODUCTIVITE_TRAVAILLEUR_OR, active)
{
