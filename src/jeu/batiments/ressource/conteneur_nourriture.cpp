#include "conteneur_nourriture.h"

Conteneur_nourriture::Conteneur_nourriture(QObject* parent) :  Conteneur(parent, MAX_PV_CONTENEUR_NOURRITURE, QSize(TAILLE_CONTENEUR_NOURRITURE_W, TAILLE_CONTENEUR_NOURRITURE_H), cout{COUT_CONSTRUCTION_CONTENEUR_NOURRITURE_NOURRITURE, COUT_CONSTRUCTION_CONTENEUR_NOURRITURE_OR, XP_CONTENEUR}, CONTENANCE_MAX_CONTENEUR_NOURRITURE)
{
