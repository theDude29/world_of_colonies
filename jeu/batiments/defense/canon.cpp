...
Canon::Canon() : Defense(MAX_PV_CANON, QSize(TAILLE_CANON_X, TAILLE_CANON_Z), cout{COUT_CONSTRUCTION_NOURRITURE_CANON, COUT_CONSTRUCTION_OR_CANON, XP_CANON})
{
    m_typeBatiment = canon;

    m_meshBatiment = SceneManager::getSceneManager()->getMesh("mesh/defense/canon.obj");
