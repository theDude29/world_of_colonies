...
CampEntrainement::CampEntrainement() : Batiment(MAX_PV_CAMP_ENTRAINEMENT, QSize(TAILLE_CAMP_ENTRAINEMENT_X, TAILLE_CAMP_ENTRAINEMENT_Z), cout{COUT_CONSTRUCTION_NOURRITURE_CAMP_ENTRAINEMENT, COUT_CONSTRUCTION_OR_CAMP_ENTRAINEMENT, XP_CAMP_ENTRAINEMENT})
{
