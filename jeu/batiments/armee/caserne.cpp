...
Caserne::Caserne(QObject* parent) : Batiment(parent, MAX_PV_CASERNE, QSize(TAILLE_CASERNE_X, TAILLE_CASERNE_Z), cout{COUT_CONSTRUCTION_NOURRITURE_CASERNE, COUT_CONSTRUCTION_OR_CASERNE, XP_CASERNE})
{
